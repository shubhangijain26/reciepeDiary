...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-user-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppUserLoginLoginComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<p>login works!</p>\n    <div class=\"btn-back ripple light\" (click)=\"back()\">Back</div>\n    <h2>Sign In</h2>\n  <section  class=\"form-auth\">\n    <form [formGroup]=\"userForm\" novalidate class=\"form-group\">\n      <div class=\"usernameBox\" [class.in]=\"loginPass\">\n        <div class=\"form-group\">\n            <input\n              input\n              type=\"text\"\n              class=\"form-control\"\n              #username\n              required\n            />\n            <label label>Enter Email or Phone Number</label>\n        </div>\n      </div>\n  \n      <div class=\"passwordBox\" [class.in]=\"loginPass\">\n        <div class=\"form-group\">\n            <input\n              input\n              type=\"password\"\n              class=\"form-control\"\n              #password\n              required\n            />\n            <label label>Enter Password</label>\n        </div>\n  \n        <div class=\"form-button\">\n          <button class=\"ripple light\" (click)=\"doLogin()\">submit</button>\n        </div>\n        <!-- <button class=\"ripple light\" (click)=\"back()\">back</button> -->\n      </div>\n    \n  \n      <div class=\"buttonBox\" [class.in]=\"loginPass\">\n        <div class=\"form-button\">\n          <button class=\"ripple light\" (click)=\"loginPassword()\">\n            Login Using Password\n          </button>\n        </div>\n  \n        <div class=\"orText\">OR</div>\n  \n        <div class=\"form-button\">\n          <button class=\"ripple light\" (click)=\"requestOTP()\">\n            Login Using OTP\n          </button>\n        </div>\n      </div>\n  \n      <div class=\"forgot-action\">\n        <a routerLink=\"/user/forgot-password\">Forgot Password?</a>\n      </div>\n      \n      <div class=\"action\">\n        Not registered yet? <a routerLink=\"/user/register\">Sign Up</a>\n      </div>\n    </form>\n  </section>\n  \n  ";
    /***/
  },
  ...
  function srcAppUserLoginLoginComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".loginError {\n  margin: -10px 0 15px !important;\n}\n\n.form-auth {\n  background-color: #fff;\n  padding: 37px 20px 20px 20px;\n}\n\n.form-auth .form-group {\n  padding: 0 0 20px;\n}\n\n.form-auth .form-group .form-control {\n  border: 1px solid #e6e6e6;\n  padding: 10px;\n  border-radius: 3px;\n  font-size: 14px;\n  line-height: 20px;\n}\n\n.form-auth .form-group .isInvalid {\n  border-color: red;\n}\n\n.form-auth .form-group .error {\n  color: red;\n  font-size: 11px;\n  padding-top: 4px;\n}\n\n.form-auth .form-group input {\n  width: 50%;\n}\n\n.form-auth .form-group ::-webkit-input-placeholder {\n  /* Chrome/Opera/Safari */\n  color: #7e7e7e;\n}\n\n.form-auth .form-group ::-moz-placeholder {\n  /* Firefox 19+ */\n  color: #7e7e7e;\n}\n\n.form-auth .form-group :-ms-input-placeholder {\n  /* IE 10+ */\n  color: #7e7e7e;\n}\n\n.form-auth .form-group :-moz-placeholder {\n  /* Firefox 18- */\n  color: #7e7e7e;\n}\n\n.form-auth .form-button {\n  margin-bottom: 10px;\n}\n\n.form-auth .form-button button {\n  background-color: blueviolet;\n  color: #fff;\n  padding: 8px;\n  text-align: center;\n  width: 50%;\n  box-sizing: border-box;\n  border-radius: 2px;\n  text-transform: uppercase;\n  font-size: 14px;\n  line-height: 22px;\n  font-family: open sans semibold;\n}\n\n.form-auth .or {\n  padding: 54px 0 18px 0;\n  text-align: center;\n  font-size: 14px;\n  position: relative;\n  color: #444;\n}\n\n.form-auth .or:before {\n  content: \"\";\n  position: absolute;\n  left: 0px;\n  top: 18px;\n  width: 100%;\n  height: 1px;\n  z-index: 1;\n}\n\n.form-auth .or span {\n  position: absolute;\n  left: 50%;\n  top: 0px;\n  width: 36px;\n  height: 36px;\n  margin-left: -18px;\n  border-radius: 100%;\n  text-align: center;\n  text-transform: uppercase;\n  line-height: 36px;\n  background-color: #fff;\n  z-index: 2;\n}\n\n.form-auth .action {\n  text-align: center;\n  color: gray;\n  font-size: 16px;\n  margin-bottom: 3px;\n}\n\n.form-auth .action a {\n  color: lightblue;\n  text-decoration: none;\n}\n\n.form-auth .forgot-action {\n  text-align: center;\n  color: gray;\n  font-size: 14px;\n  margin-bottom: 16px;\n}\n\n.form-auth .forgot-action a {\n  color: lightblue;\n  text-decoration: none;\n}\n\n.form-auth .passwordBox {\n  display: none;\n}\n\n.form-auth .passwordBox.in {\n  display: block;\n}\n\n.form-auth .buttonBox {\n  display: block;\n}\n\n.form-auth .buttonBox.in {\n  display: none;\n}\n\n.form-auth .usernameBox {\n  display: block;\n}\n\n.form-auth .usernameBox.in {\n  display: none;\n}\n\n.signUpUL {\n  margin: 0 0 0 -37px;\n  list-style-type: none;\n}\n\n.show {\n  display: block;\n}\n\n.hide {\n  display: none;\n}\n\n.orText {\n  margin: 0 0 10px;\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppUserUserRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _user_routes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./user.routes */
    ...
    UserRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(_user_routes__WEBPACK_IMPORTED_MODULE_3__["routes"])],
  ...
  function srcAppUserUserModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    UserModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_user_routing_module__WEBPACK_IMPORTED_MODULE_2__["UserRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"]],
      entryComponents: [],
      providers: []
    })], UserModule);
    /***/
  ...
  function srcAppUserUserRoutesTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _user_register_register_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
